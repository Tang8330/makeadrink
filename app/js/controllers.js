...
angular.module('MixDatUp.controllers', []).
  controller('AlcoholicDrinksCtrl', [function($scope) {
	$scope.alcoholicDrinks = [
	  { "name": "Vesper",
		"glass": "martini",
